...
void Experiment::add_parameters() {
    ...
    this->add_option("-d,--data", this->data_folder, "Number of folds utilized to measure SA metrics.");
    this->add_option("-f,--folds", this->n_folds, "Number of folds utilized to measure SA metrics.");
